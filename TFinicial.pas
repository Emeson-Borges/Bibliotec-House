...
var
  i : integer;
begin
//Código do botão para cadastrar
  ...
  while ProgressBar1.Position < 100 do
     begin
       if ProgressBar1.Position < 50 then
        ...
        // For para verificar se os itens estão vazios
        ...
        begin
            ...
            // ESSE CÓDIGO TA PEGANDO O VALOR DO CAMPOS QUE NÃO SÃO DO TIPO DB
...
// Código para iniciar com todos os campos zerados
