...
//Código para verificar os campos de filtro
...
if (Application.MessageBox('Deseja realmente deletar essas informações?',
...
begin
  //Habilitar a Grido do Banco para Edição
...
procedure TFrm_previa.BtnRelatórioClick(Sender: TObject);
begin
